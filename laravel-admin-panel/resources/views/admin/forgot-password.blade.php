                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Sanırım şifrenizi unuttunuz! Aşayığa e-mail adresinizi girin ve size gönderdiğimiz bağlantıya
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{route('admin.register')}}">Hesap Oluşturun!</a>
                                    </div>
                                    <div class="text-center">
